function [Bu,Bv,Bw,L] = auxiliary_matrices2(ini_Val,Invariant_main_b,Invariant_main_u)
...
Bu = zeros(Invariant_main_b.num_cp);
Bu(end,Invariant_main_b.num_cp-ini_Val.p:Invariant_main_b.num_cp) = Invariant_main_b.Nsh_b_1(1,:); 
