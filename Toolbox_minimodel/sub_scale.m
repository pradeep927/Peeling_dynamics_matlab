function [u_g_,du_g_,u_g,du_g,du_g_1,du_g_0]  = sub_scale(Mat,Invariant,UU,theta);
...
[U_,Fval,eFlag,output,gradE_1]      = fminunc(@(U)Energy_mini_rescale(U,alpha,F_mini),Invariant_mini.U0,options_mini);
