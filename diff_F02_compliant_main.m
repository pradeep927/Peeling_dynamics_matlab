...
load('Initial_equlibrium_compliant_diff.mat')
g=2;
...
%  x_gamma         = 1.186645082178267e-04; %L0n/gamma5;
...
% 
%  Invariant_main_b.num_el=400;     % Number of elements in the bound region  150
...
delta_t =8.1633e-7*1;           % Time-step
num_t = 7000;               % Number of time-steps
...
%    if type ==1 || type==2    % Slip/catch bonds
    ...
    u_g_hist =[u_g_hist,u_g];
     ...
     if rem(i,500)==0
    save('Diff_F0_2_compliant_k1.mat');
    end
